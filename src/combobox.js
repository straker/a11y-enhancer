...
const OPTIONS_ID = 'ae_combobox-option';
...
function combobox(element, shadowRoot) {
  ...
  let currentOption, lastOptionIndex;
  ...
  let listbox = root.querySelector('[role="listbox"]');
  ...
  root.addEventListener('keydown', e => {
    ...
    if (e.altKey && (e.which === KEYS.up || e.which === KEYS.down)) {
      e.preventDefault();
      toggleListbox();
